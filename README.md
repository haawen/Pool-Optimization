...
This builds us 3 executables
  ...
  - `libpool_shared` the shared library which will be called by pooltool
...
Now if you start it should print the restitution, velocity and angular velocity vectors of the balls.
