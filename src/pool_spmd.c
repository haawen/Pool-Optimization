...
DLL_EXPORT void spmd_basic_collide_balls(
    ...
    Profile *profiles, Branch *branches)
{
    __asm volatile("# LLVM-MCA-BEGIN SPMD_basic_impl" ::: "memory");
#ifdef PROFILE
    ...
    FLOPS(6 * 4, 12 * 4, 0, 0, complete_function, after_loop);
    ...
    FLOPS(4 * 4, 8 * 4, 0, 0, complete_function, after_loop);
...
/**
 * Basic SPMD version augmented with FMA instructions.
 */
DLL_EXPORT void spmd2_FMA(
    double *col1_rvw1, double *col1_rvw2,
    double *col2_rvw1, double *col2_rvw2,
    double *col3_rvw1, double *col3_rvw2,
    double *col4_rvw1, double *col4_rvw2,
    ...
    Profile *profiles, Branch *branches)
{
    __asm volatile("# LLVM-MCA-BEGIN SPMD2_FMA" ::: "memory");
#ifdef PROFILE
    Profile *complete_function = &profiles[0];
    Profile *before_loop = &profiles[1];
    Profile *impulse = &profiles[2];
    ...
    FLOPS(2 * 4, 3 * 4, 0, 0, complete_function, before_loop);
    __m256d offset_squared_1 = _mm256_mul_pd(offset_1, offset_1);
    __m256d offset_tmp = _mm256_fmadd_pd(offset_0, offset_0, offset_squared_1);
    __m256d offset_magnitude_squared = _mm256_fmadd_pd(offset_2, offset_2, offset_tmp);
    ...
    // Right
    FLOPS(3 * 4, 6 * 4, 0, 0, complete_function, before_loop);
    __m256d right_0_tmp = _mm256_mul_pd(forward_1, up_2);
    __m256d right_0 = _mm256_fnmadd_pd(forward_2, up_1, right_0_tmp);

    __m256d right_1_tmp = _mm256_mul_pd(forward_2, up_0);
    __m256d right_1 = _mm256_fnmadd_pd(forward_0, up_2, right_1_tmp);

    __m256d right_2_tmp = _mm256_mul_pd(forward_0, up_1);
    __m256d right_2 = _mm256_fnmadd_pd(forward_1, up_0, right_2_tmp);

    // Transform velocities to local frame
    FLOPS(2 * 4 * 4, 3 * 4 * 4, 0, 0, complete_function, before_loop);
    __m256d local_velocity_x_1_tmp_0 = _mm256_mul_pd(velocity_1_rvw1, right_1);
    __m256d local_velocity_x_1_tmp_1 = _mm256_fmadd_pd(velocity_0_rvw1, right_0, local_velocity_x_1_tmp_0);
    __m256d local_velocity_x_1 = _mm256_fmadd_pd(velocity_2_rvw1, right_2, local_velocity_x_1_tmp_1);

    __m256d local_velocity_y_1_tmp_0 = _mm256_mul_pd(velocity_0_rvw1, forward_0);
    __m256d local_velocity_y_1_tmp_1 = _mm256_fmadd_pd(velocity_1_rvw1, forward_1, local_velocity_y_1_tmp_0);
    __m256d local_velocity_y_1 = _mm256_fmadd_pd(velocity_2_rvw1, forward_2, local_velocity_y_1_tmp_1);

    __m256d local_velocity_x_2_tmp_0 = _mm256_mul_pd(velocity_0_rvw2, right_0);
    __m256d local_velocity_x_2_tmp_1 = _mm256_fmadd_pd(velocity_1_rvw2, right_1, local_velocity_x_2_tmp_0);
    __m256d local_velocity_x_2 = _mm256_fmadd_pd(velocity_2_rvw2, right_2, local_velocity_x_2_tmp_1);

    __m256d local_velocity_y_2_tmp_0 = _mm256_mul_pd(velocity_0_rvw2, forward_0);
    __m256d local_velocity_y_2_tmp_1 = _mm256_fmadd_pd(velocity_1_rvw2, forward_1, local_velocity_y_2_tmp_0);
    __m256d local_velocity_y_2 = _mm256_fmadd_pd(velocity_2_rvw2, forward_2, local_velocity_y_2_tmp_1);

    // Transform angular velocities to local frame
    FLOPS(2 * 6 * 4, 3 * 6 * 4, 0, 0, complete_function, before_loop);
    __m256d local_angular_velocity_x_1_tmp_0 = _mm256_mul_pd(angular_velocity_0_rvw1, right_0);
    __m256d local_angular_velocity_x_1_tmp_1 = _mm256_fmadd_pd(angular_velocity_1_rvw1, right_1, local_angular_velocity_x_1_tmp_0);
    __m256d local_angular_velocity_x_1 = _mm256_fmadd_pd(angular_velocity_2_rvw1, right_2, local_angular_velocity_x_1_tmp_1);

    __m256d local_angular_velocity_y_1_tmp_0 = _mm256_mul_pd(angular_velocity_0_rvw1, forward_0);
    __m256d local_angular_velocity_y_1_tmp_1 = _mm256_fmadd_pd(angular_velocity_1_rvw1, forward_1, local_angular_velocity_y_1_tmp_0);
    __m256d local_angular_velocity_y_1 = _mm256_fmadd_pd(angular_velocity_2_rvw1, forward_2, local_angular_velocity_y_1_tmp_1);

    __m256d local_angular_velocity_z_1_tmp_0 = _mm256_mul_pd(angular_velocity_0_rvw1, up_0);
    __m256d local_angular_velocity_z_1_tmp_1 = _mm256_fmadd_pd(angular_velocity_1_rvw1, up_1, local_angular_velocity_z_1_tmp_0);
    __m256d local_angular_velocity_z_1 = _mm256_fmadd_pd(angular_velocity_2_rvw1, up_2, local_angular_velocity_z_1_tmp_1);

    __m256d local_angular_velocity_x_2_tmp_0 = _mm256_mul_pd(angular_velocity_0_rvw2, right_0);
    __m256d local_angular_velocity_x_2_tmp_1 = _mm256_fmadd_pd(angular_velocity_1_rvw2, right_1, local_angular_velocity_x_2_tmp_0);
    __m256d local_angular_velocity_x_2 = _mm256_fmadd_pd(angular_velocity_2_rvw2, right_2, local_angular_velocity_x_2_tmp_1);

    __m256d local_angular_velocity_y_2_tmp_0 = _mm256_mul_pd(angular_velocity_0_rvw2, forward_0);
    __m256d local_angular_velocity_y_2_tmp_1 = _mm256_fmadd_pd(angular_velocity_1_rvw2, forward_1, local_angular_velocity_y_2_tmp_0);
    __m256d local_angular_velocity_y_2 = _mm256_fmadd_pd(angular_velocity_2_rvw2, forward_2, local_angular_velocity_y_2_tmp_1);

    __m256d local_angular_velocity_z_2_tmp_0 = _mm256_mul_pd(angular_velocity_0_rvw2, up_0);
    __m256d local_angular_velocity_z_2_tmp_1 = _mm256_fmadd_pd(angular_velocity_1_rvw2, up_1, local_angular_velocity_z_2_tmp_0);
    __m256d local_angular_velocity_z_2 = _mm256_fmadd_pd(angular_velocity_2_rvw2, up_2, local_angular_velocity_z_2_tmp_1);

    // Surface velocity
    __m256d spmd_R = _mm256_set1_pd(R);
    FLOPS(4 * 4, 4 * 4, 0, 0, complete_function, before_loop);
    __m256d surface_velocity_x_1 = _mm256_fmadd_pd(local_angular_velocity_y_1, spmd_R, local_velocity_x_1);

    __m256d surface_velocity_y_1 = _mm256_fnmadd_pd(local_angular_velocity_x_1, spmd_R, local_velocity_y_1);

    __m256d surface_velocity_x_2 = _mm256_fmadd_pd(local_angular_velocity_y_2, spmd_R, local_velocity_x_2);

    __m256d surface_velocity_y_2 = _mm256_fnmadd_pd(local_angular_velocity_x_2, spmd_R, local_velocity_y_2);

    // Surface Velocity Magnitude
    FLOPS(2 * 4, 4 * 4, 0, 2 * 4, complete_function, before_loop);
    __m256d surface_velocity_x_1_squared = _mm256_mul_pd(surface_velocity_x_1, surface_velocity_x_1);
    __m256d surface_velocity_magnitude_1_tmp_0 = _mm256_fmadd_pd(surface_velocity_y_1, surface_velocity_y_1, surface_velocity_x_1_squared);
    __m256d surface_velocity_magnitude_1 = _mm256_sqrt_pd(surface_velocity_magnitude_1_tmp_0);

    __m256d surface_velocity_x_2_squared = _mm256_mul_pd(surface_velocity_x_2, surface_velocity_x_2);
    __m256d surface_velocity_magnitude_2_tmp_0 = _mm256_fmadd_pd(surface_velocity_y_2, surface_velocity_y_2, surface_velocity_x_2_squared);
    __m256d surface_velocity_magnitude_2 = _mm256_sqrt_pd(surface_velocity_magnitude_2_tmp_0);

    // Ball-ball slip
    FLOPS(5 * 4, 5 * 4, 0, 1 * 4, complete_function, before_loop);
    __m256d contact_point_velocity_x_tmp_0 = _mm256_add_pd(local_angular_velocity_z_1, local_angular_velocity_z_2);
    __m256d contact_point_velocity_x_tmp_1 = _mm256_sub_pd(local_velocity_x_1, local_velocity_x_2);
    __m256d contact_point_velocity_x = _mm256_fnmadd_pd(spmd_R, contact_point_velocity_x_tmp_0, contact_point_velocity_x_tmp_1);

    __m256d contact_point_velocity_z_tmp_0 = _mm256_mul_pd(spmd_R, local_angular_velocity_x_1);
    __m256d contact_point_velocity_z = _mm256_fmadd_pd(spmd_R, local_angular_velocity_x_2, contact_point_velocity_z_tmp_0);

    __m256d ball_ball_contact_point_magnitude_tmp_0 = _mm256_mul_pd(contact_point_velocity_x, contact_point_velocity_x);
    __m256d ball_ball_contact_point_magnitude_tmp_1 = _mm256_fmadd_pd(contact_point_velocity_z, contact_point_velocity_z, ball_ball_contact_point_magnitude_tmp_0);
    __m256d ball_ball_contact_point_magnitude = _mm256_sqrt_pd(ball_ball_contact_point_magnitude_tmp_1);
    ...
    while (_mm256_movemask_pd(loop_mask) != 0)
    {
        ...
        // Angular velocity changes
        FLOPS(8 * 4, 6 * 4, 0, 0, complete_function, delta);
        __m256d neg_deltaP_x_1 = _mm256_xor_pd(deltaP_x_1, sign_mask);
        __m256d neg_deltaP_x_2 = _mm256_xor_pd(deltaP_x_2, sign_mask);
        ...
        __m256d new_local_angular_velocity_x_1 = _mm256_fmadd_pd(spmd_C, delta_angular_velocity_x_1_tmp, local_angular_velocity_x_1);
        __m256d new_local_angular_velocity_y_1 = _mm256_fmadd_pd(spmd_C, neg_deltaP_x_1, local_angular_velocity_y_1);
        __m256d new_local_angular_velocity_z_1 = _mm256_fmadd_pd(spmd_C, neg_deltaP_1, local_angular_velocity_z_1);
        __m256d new_local_angular_velocity_x_2 = _mm256_fmadd_pd(spmd_C, delta_angular_velocity_x_2_tmp, local_angular_velocity_x_2);
        __m256d new_local_angular_velocity_y_2 = _mm256_fmadd_pd(spmd_C, neg_deltaP_x_2, local_angular_velocity_y_2);
        __m256d new_local_angular_velocity_z_2 = _mm256_fmadd_pd(spmd_C, neg_deltaP_1, local_angular_velocity_z_2);
        ...
        // Update ball-table slips
        FLOPS(4 * 4, 4 * 4, 0, 0, complete_function, velocity);
        __m256d new_surface_velocity_x_1 = _mm256_fmadd_pd(spmd_R, local_angular_velocity_y_1, local_velocity_x_1);
        surface_velocity_x_1 = _mm256_blendv_pd(surface_velocity_x_1, new_surface_velocity_x_1, loop_mask);

        __m256d new_surface_velocity_y_1 = _mm256_fnmadd_pd(spmd_R, local_angular_velocity_x_1, local_velocity_y_1);
        surface_velocity_y_1 = _mm256_blendv_pd(surface_velocity_y_1, new_surface_velocity_y_1, loop_mask);

        __m256d new_surface_velocity_x_2 = _mm256_fmadd_pd(spmd_R, local_angular_velocity_y_2, local_velocity_x_2);
        surface_velocity_x_2 = _mm256_blendv_pd(surface_velocity_x_2, new_surface_velocity_x_2, loop_mask);

        __m256d new_surface_velocity_y_2 = _mm256_fnmadd_pd(spmd_R, local_angular_velocity_x_2, local_velocity_y_2);
        surface_velocity_y_2 = _mm256_blendv_pd(surface_velocity_y_2, new_surface_velocity_y_2, loop_mask);

        FLOPS(2 * 4, 4 * 4, 0, 2 * 4, complete_function, velocity);
        __m256d new_surface_velocity_x_1_squared = _mm256_mul_pd(surface_velocity_x_1, surface_velocity_x_1);
        __m256d new_addded_squared_1 = _mm256_fmadd_pd(surface_velocity_y_1, surface_velocity_y_1, new_surface_velocity_x_1_squared);
        __m256d new_surface_velocity_magnitude_1 = _mm256_sqrt_pd(new_addded_squared_1);
        surface_velocity_magnitude_1 = _mm256_blendv_pd(surface_velocity_magnitude_1, new_surface_velocity_magnitude_1, loop_mask);

        __m256d new_surface_velocity_x_2_squared = _mm256_mul_pd(surface_velocity_x_2, surface_velocity_x_2);
        __m256d new_addded_squared_2 = _mm256_fmadd_pd(surface_velocity_y_2, surface_velocity_y_2, new_surface_velocity_x_2_squared);
        __m256d new_surface_velocity_magnitude_2 = _mm256_sqrt_pd(new_addded_squared_2);
        surface_velocity_magnitude_2 = _mm256_blendv_pd(surface_velocity_magnitude_2, new_surface_velocity_magnitude_2, loop_mask);
        ...
        FLOPS(5 * 4, 4 * 4, 0, 1 * 4, complete_function, velocity);
        __m256d new_contact_point_velocity_x_tmp_0 = _mm256_add_pd(local_angular_velocity_z_1, local_angular_velocity_z_2);
        __m256d new_contact_point_velocity_x_tmp_1 = _mm256_sub_pd(local_velocity_x_1, local_velocity_x_2);
        __m256d new_contact_point_velocity_x = _mm256_fnmadd_pd(spmd_R, new_contact_point_velocity_x_tmp_0, new_contact_point_velocity_x_tmp_1);
        contact_point_velocity_x = _mm256_blendv_pd(contact_point_velocity_x, new_contact_point_velocity_x, loop_mask);
        ...
        __m256d new_ball_ball_contact_point_magnitude_tmp_0 = _mm256_mul_pd(contact_point_velocity_x, contact_point_velocity_x);
        __m256d new_ball_ball_contact_point_magnitude_tmp_1 = _mm256_fmadd_pd(contact_point_velocity_z, contact_point_velocity_z, new_ball_ball_contact_point_magnitude_tmp_0);
        __m256d new_ball_ball_contact_point_magnitude = _mm256_sqrt_pd(new_ball_ball_contact_point_magnitude_tmp_1);
        ball_ball_contact_point_magnitude = _mm256_blendv_pd(ball_ball_contact_point_magnitude, new_ball_ball_contact_point_magnitude, loop_mask);
        ...
        __m256d total_work_tmp_2 = _mm256_set1_pd(0.5);
        __m256d total_work_tmp_3 = _mm256_mul_pd(total_work_tmp_2, deltaP_vec);
        __m256d new_total_work = _mm256_fmadd_pd(total_work_tmp_3, total_work_tmp_1, total_work);
        total_work = _mm256_blendv_pd(total_work, new_total_work, loop_mask);

        // Work branch
        FLOPS(1 * 4, 2 * 4, 0, 0, complete_function, velocity);
        __m256d new_work_required_tmp_0 = _mm256_set1_pd(1.0);
        __m256d new_work_required_tmp_1 = _mm256_fmadd_pd(spmd_e_b, spmd_e_b, new_work_required_tmp_0);
        __m256d new_work_required = _mm256_mul_pd(new_work_required_tmp_1, total_work);
    ...
    FLOPS(6 * 4, 12 * 4, 0, 0, complete_function, after_loop);
    __m256d world_v1_x_tmp_0 = _mm256_mul_pd(local_velocity_x_1, right_0);
    __m256d world_v1_x = _mm256_fmadd_pd(local_velocity_y_1, forward_0, world_v1_x_tmp_0);
    __m256d world_v1_y_tmp_0 = _mm256_mul_pd(local_velocity_x_1, right_1);
    __m256d world_v1_y = _mm256_fmadd_pd(local_velocity_y_1, forward_1, world_v1_y_tmp_0);
    __m256d world_v1_z_tmp_0 = _mm256_mul_pd(local_velocity_x_1, right_2);
    __m256d world_v1_z = _mm256_fmadd_pd(local_velocity_y_1, forward_2, world_v1_z_tmp_0);
    __m256d world_v2_x_tmp_0 = _mm256_mul_pd(local_velocity_x_2, right_0);
    __m256d world_v2_x = _mm256_fmadd_pd(local_velocity_y_2, forward_0, world_v2_x_tmp_0);
    __m256d world_v2_y_tmp_0 = _mm256_mul_pd(local_velocity_x_2, right_1);
    __m256d world_v2_y = _mm256_fmadd_pd(local_velocity_y_2, forward_1, world_v2_y_tmp_0);
    __m256d world_v2_z_tmp_0 = _mm256_mul_pd(local_velocity_x_2, right_2);
    __m256d world_v2_z = _mm256_fmadd_pd(local_velocity_y_2, forward_2, world_v2_z_tmp_0);

    FLOPS(4 * 4, 8 * 4, 0, 0, complete_function, after_loop);
    __m256d world_w1_x_tmp_0 = _mm256_mul_pd(local_angular_velocity_x_1, right_0);
    __m256d world_w1_x = _mm256_fmadd_pd(local_angular_velocity_y_1, forward_0, world_w1_x_tmp_0);
    __m256d world_w1_y_tmp_0 = _mm256_mul_pd(local_angular_velocity_x_1, right_1);
    __m256d world_w1_y = _mm256_fmadd_pd(local_angular_velocity_y_1, forward_1, world_w1_y_tmp_0);
    __m256d world_w1_z = local_angular_velocity_z_1;
    __m256d world_w2_x_tmp_0 = _mm256_mul_pd(local_angular_velocity_x_2, right_0);
    __m256d world_w2_x = _mm256_fmadd_pd(local_angular_velocity_y_2, forward_0, world_w2_x_tmp_0);
    __m256d world_w2_y_tmp_0 = _mm256_mul_pd(local_angular_velocity_x_2, right_1);
    __m256d world_w2_y = _mm256_fmadd_pd(local_angular_velocity_y_2, forward_1, world_w2_y_tmp_0);
    __m256d world_w2_z = local_angular_velocity_z_2;
...
static inline __m256d rsqrt_nr_pd(__m256d x)
{
    __m128 x_ps = _mm256_cvtpd_ps(x);
    __m128 y0 = _mm_rsqrt_ps(x_ps);
    __m256d inv = _mm256_cvtps_pd(y0);

    __m256d half = _mm256_set1_pd(0.5);
    __m256d one_pt_five = _mm256_set1_pd(1.5);

    __m256d inv_sq = _mm256_mul_pd(inv, inv);
    __m256d x_inv_sq = _mm256_mul_pd(x, inv_sq);
    __m256d term = _mm256_fnmadd_pd(x_inv_sq, half, one_pt_five);
    return _mm256_mul_pd(inv, term);
}

/**
 * SPMD FMA version with a reciprocal sqrt operation.
 */
DLL_EXPORT void spmd3_Recip_Sqrt(
    double *col1_rvw1, double *col1_rvw2,
    double *col2_rvw1, double *col2_rvw2,
    double *col3_rvw1, double *col3_rvw2,
    double *col4_rvw1, double *col4_rvw2,
    ...
    Profile *profiles, Branch *branches)
{
    __asm volatile("# LLVM-MCA-BEGIN SPMD3_Recip_sqrt" ::: "memory");
#ifdef PROFILE
    Profile *complete_function = &profiles[0];
    Profile *before_loop = &profiles[1];
    Profile *impulse = &profiles[2];
    ...
    // Offset magnitude
    FLOPS(0, 0, 0, 1 * 4, complete_function, before_loop);
    // Don't use the reciprocal square root function here, Accuracy!
    __m256d offset_magnitude = _mm256_sqrt_pd(offset_magnitude_squared);
    ...
    __m256d surface_velocity_x_1_squared = _mm256_mul_pd(surface_velocity_x_1, surface_velocity_x_1);
    __m256d surface_velocity_magnitude_1_tmp_0 = _mm256_fmadd_pd(surface_velocity_y_1, surface_velocity_y_1, surface_velocity_x_1_squared);
    __m256d inv_surface_velocity_magnitude_1 = rsqrt_nr_pd(surface_velocity_magnitude_1_tmp_0);

    __m256d surface_velocity_x_2_squared = _mm256_mul_pd(surface_velocity_x_2, surface_velocity_x_2);
    __m256d surface_velocity_magnitude_2_tmp_0 = _mm256_fmadd_pd(surface_velocity_y_2, surface_velocity_y_2, surface_velocity_x_2_squared);
    __m256d inv_surface_velocity_magnitude_2 = rsqrt_nr_pd(surface_velocity_magnitude_2_tmp_0);
    ...
    {
        START_PROFILE(impulse);
        FLOPS(1 * 4, 2 * 4, 0, 1 * 4, complete_function, impulse);
        __m256d cbm2_tmp = _mm256_mul_pd(contact_point_velocity_x, contact_point_velocity_x);
        __m256d cbm2 = _mm256_fmadd_pd(contact_point_velocity_z, contact_point_velocity_z, cbm2_tmp);

        __m256d cp_inv = rsqrt_nr_pd(cbm2);

        // Branch 1
        FLOPS(0, 3 * 4, 0, 0, complete_function, impulse);
        __m256d deltaP_1_new_tmp_0 = _mm256_mul_pd(spmd_minus_u_b, deltaP_vec);
        __m256d deltaP_1_new_tmp_1 = _mm256_mul_pd(deltaP_1_new_tmp_0, contact_point_velocity_x);
        __m256d deltaP_1_new = _mm256_mul_pd(deltaP_1_new_tmp_1, cp_inv);

        // Branch 3
        FLOPS(0, 3 * 4, 0, 0, complete_function, impulse);
        __m256d deltaP_2_new_tmp_0 = _mm256_mul_pd(spmd_minus_u_b, deltaP_vec);
        __m256d deltaP_2_new_tmp_1 = _mm256_mul_pd(deltaP_2_new_tmp_0, contact_point_velocity_z);
        __m256d deltaP_2_new = _mm256_mul_pd(deltaP_2_new_tmp_1, cp_inv);

        // Branch 6
        FLOPS(0, 6 * 4, 0, 0, complete_function, impulse);
        __m256d deltaP_x_2_new_tmp_0 = _mm256_mul_pd(surface_velocity_x_2, inv_surface_velocity_magnitude_2);
        __m256d deltaP_x_2_new_tmp_1 = _mm256_mul_pd(spmd_minus_u_s2, deltaP_x_2_new_tmp_0);
        __m256d deltaP_x_2_new = _mm256_mul_pd(deltaP_x_2_new_tmp_1, deltaP_2_new);

        __m256d deltaP_y_2_new_tmp_0 = _mm256_mul_pd(surface_velocity_y_2, inv_surface_velocity_magnitude_2);
        __m256d deltaP_y_2_new_tmp_1 = _mm256_mul_pd(spmd_minus_u_s2, deltaP_y_2_new_tmp_0);
        __m256d deltaP_y_2_new = _mm256_mul_pd(deltaP_y_2_new_tmp_1, deltaP_2_new);

        // Branch 9
        FLOPS(0, 6 * 4, 0, 0, complete_function, impulse);
        __m256d deltaP_x_1_new_tmp_0 = _mm256_mul_pd(surface_velocity_x_1, inv_surface_velocity_magnitude_1);
        __m256d deltaP_x_1_new_tmp_1 = _mm256_mul_pd(spmd_u_s1, deltaP_x_1_new_tmp_0);
        __m256d deltaP_x_1_new = _mm256_mul_pd(deltaP_x_1_new_tmp_1, deltaP_2_new);

        __m256d deltaP_y_1_new_tmp_0 = _mm256_mul_pd(surface_velocity_y_1, inv_surface_velocity_magnitude_1);
        __m256d deltaP_y_1_new_tmp_1 = _mm256_mul_pd(spmd_u_s1, deltaP_y_1_new_tmp_0);
        __m256d deltaP_y_1_new = _mm256_mul_pd(deltaP_y_1_new_tmp_1, deltaP_2_new);
        ...
        __m256d mask_branch_6_only = _mm256_cmp_pd(inv_surface_velocity_magnitude_2, zero, _CMP_NEQ_OQ);
        __m256d mask_branch_6_tmp = _mm256_and_pd(mask_branch_3, mask_branch_4_only);
        __m256d mask_branch_6 = _mm256_and_pd(mask_branch_6_tmp, mask_branch_6_only);

        __m256d mask_branch_7_only = _mm256_cmp_pd(deltaP_2_new, zero, _CMP_LE_OQ);

        __m256d mask_branch_9_only = _mm256_cmp_pd(inv_surface_velocity_magnitude_1, zero, _CMP_NEQ_OQ);
        __m256d mask_branch_9_tmp = _mm256_and_pd(mask_branch_3, mask_branch_7_only);
        __m256d mask_branch_9 = _mm256_and_pd(mask_branch_9_tmp, mask_branch_9_only);
        ...
        __m256d new_surface_velocity_x_1_squared = _mm256_mul_pd(surface_velocity_x_1, surface_velocity_x_1);
        __m256d new_addded_squared_1 = _mm256_fmadd_pd(surface_velocity_y_1, surface_velocity_y_1, new_surface_velocity_x_1_squared);
        __m256d new_inv_surface_velocity_magnitude_1 = rsqrt_nr_pd(new_addded_squared_1);
        inv_surface_velocity_magnitude_1 = _mm256_blendv_pd(inv_surface_velocity_magnitude_1, new_inv_surface_velocity_magnitude_1, loop_mask);

        __m256d new_surface_velocity_x_2_squared = _mm256_mul_pd(surface_velocity_x_2, surface_velocity_x_2);
        __m256d new_addded_squared_2 = _mm256_fmadd_pd(surface_velocity_y_2, surface_velocity_y_2, new_surface_velocity_x_2_squared);
        __m256d new_inv_surface_velocity_magnitude_2 = rsqrt_nr_pd(new_addded_squared_2);
        inv_surface_velocity_magnitude_2 = _mm256_blendv_pd(inv_surface_velocity_magnitude_2, new_inv_surface_velocity_magnitude_2, loop_mask);
