...
typedef void (*CollideBallsFn)(double*, double*, float, float, float, float, float, float, float, int, double*, double*);
...
void call_function(const char* name, CollideBallsFn collide_fn) {
        ...
        collide_fn(rvw1, rvw2, 0.028575f, 0.170097, 0.2, 0.2, 0.08734384602561387, 0.95, 0.0, 1000, rvw1_result, rvw2_result);
